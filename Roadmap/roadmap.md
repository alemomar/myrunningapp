...
- **Décision (2026-09-12, ajustée)** : séances/semaine (course + renfo/mobilité) et km/mois+km/an ont finalement rejoint le tronc commun (carte "Ton profil coureur"), plutôt que d'être conditionnés par le type d'objectif ("Rythme visé" existant, retiré) — peu importe l'objectif principal, l'utilisateur doit pouvoir se fixer un volume d'entraînement, et c'est le même volume réel qu'on ne duplique pas entre principal/secondaire.
...
- ~~**Courir plus régulièrement** : créneaux/jours disponibles, principaux freins (motivation/météo/temps/fatigue), préférence de rappel.~~ **Fait (2026-09-12)** — nouveau bloc "Ta régularité" (fréquence actuelle déjà couverte par "Ta situation actuelle").
- **Reprendre après une pause/blessure** : **Retiré temporairement des choix (2026-09-12)** — jugé trop technique en l'état par Omar, à retravailler avant de le reproposer. Le code existant (bloc conditionnel, carte "Contexte de la reprise", durée d'arrêt + zone concernée) reste en place mais l'objectif n'apparaît plus dans les cartes sélectionnables ; réactivable en une ligne (`OBJECTIF_ICONS`). Reste à faire si/quand on le reprend : type d'interruption (blessure/maladie/indispo/sans raison), statut de la blessure (guérie/en rééducation/feu vert médical), niveau avant la pause, douleur actuelle au repos et à l'effort.
- ~~**Rester en forme** : autres activités pratiquées, motivation principale (santé/sommeil/mental/poids), et une question franche : veut-il des objectifs chiffrés du tout, ou juste du suivi passif ?~~ **Fait (2026-09-14)** — carte "Ton profil bien-être".
